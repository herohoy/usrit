 package com.today36524.api.user.response.serializer;
        ...
        *  @generated
        **/
        public class UnfreezeUserResponseSerializer implements BeanSerializer<com.today36524.api.user.response.UnfreezeUserResponse>{
        
      @Override
      public com.today36524.api.user.response.UnfreezeUserResponse read(TProtocol iprot) throws TException{

      com.today36524.api.user.response.UnfreezeUserResponse bean = new com.today36524.api.user.response.UnfreezeUserResponse();
      ...
      @Override
      public void write(com.today36524.api.user.response.UnfreezeUserResponse bean, TProtocol oprot) throws TException{
      ...
      public void validate(com.today36524.api.user.response.UnfreezeUserResponse bean) throws TException{
        ...
        @Override
        public String toString(com.today36524.api.user.response.UnfreezeUserResponse bean)
