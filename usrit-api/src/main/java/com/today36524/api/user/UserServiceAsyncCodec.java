package com.today36524.api.user;
        ...
        import com.today36524.api.user.service.UserServiceAsync;
        /**
      ...
      public void validate(registerUser_result bean) throws TException{
            ...
            public static class registerUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, registerUser_args, registerUser_result>
            {
              public registerUser()
              {
              ...
              @Override
              public CompletableFuture<registerUser_result> apply(UserServiceAsync iface, registerUser_args registerUser_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.RegisterUserResponse> result = (CompletableFuture<com.today36524.api.user.response.RegisterUserResponse>) iface.registerUser(registerUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.RegisterUserResponse i) -> {
                  registerUser_result res = new registerUser_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(login_result bean) throws TException{
            ...
            public static class login<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, login_args, login_result>
            {
              public login()
              {
              ...
              @Override
              public CompletableFuture<login_result> apply(UserServiceAsync iface, login_args login_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.LoginUserResponse> result = (CompletableFuture<com.today36524.api.user.response.LoginUserResponse>) iface.login(login_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.LoginUserResponse i) -> {
                  login_result res = new login_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(modifyUser_result bean) throws TException{
            ...
            public static class modifyUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, modifyUser_args, modifyUser_result>
            {
              public modifyUser()
              {
              ...
              @Override
              public CompletableFuture<modifyUser_result> apply(UserServiceAsync iface, modifyUser_args modifyUser_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.ModifyUserResponse> result = (CompletableFuture<com.today36524.api.user.response.ModifyUserResponse>) iface.modifyUser(modifyUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.ModifyUserResponse i) -> {
                  modifyUser_result res = new modifyUser_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(freezeUser_result bean) throws TException{
            ...
            public static class freezeUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, freezeUser_args, freezeUser_result>
            {
              public freezeUser()
              {
              ...
              @Override
              public CompletableFuture<freezeUser_result> apply(UserServiceAsync iface, freezeUser_args freezeUser_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.FreezeUserResponse> result = (CompletableFuture<com.today36524.api.user.response.FreezeUserResponse>) iface.freezeUser(freezeUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.FreezeUserResponse i) -> {
                  freezeUser_result res = new freezeUser_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(blackUser_result bean) throws TException{
            ...
            public static class blackUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, blackUser_args, blackUser_result>
            {
              public blackUser()
              {
              ...
              @Override
              public CompletableFuture<blackUser_result> apply(UserServiceAsync iface, blackUser_args blackUser_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.BlackUserResponse> result = (CompletableFuture<com.today36524.api.user.response.BlackUserResponse>) iface.blackUser(blackUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.BlackUserResponse i) -> {
                  blackUser_result res = new blackUser_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(changeUserIntegral_result bean) throws TException{
            ...
            public static class changeUserIntegral<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, changeUserIntegral_args, changeUserIntegral_result>
            {
              ...
              @Override
              public CompletableFuture<changeUserIntegral_result> apply(UserServiceAsync iface, changeUserIntegral_args changeUserIntegral_args) throws SoaException
              {

                CompletableFuture<Integer> result = (CompletableFuture<Integer>) iface.changeUserIntegral(changeUserIntegral_args.request ,50000);

                return result.thenApply(( Integer i) -> {
                  changeUserIntegral_result res = new changeUserIntegral_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(unfreezeUser_result bean) throws TException{
            ...
            public static class unfreezeUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, unfreezeUser_args, unfreezeUser_result>
            {
              public unfreezeUser()
              {
              ...
              @Override
              public CompletableFuture<unfreezeUser_result> apply(UserServiceAsync iface, unfreezeUser_args unfreezeUser_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.UnfreezeUserResponse> result = (CompletableFuture<com.today36524.api.user.response.UnfreezeUserResponse>) iface.unfreezeUser(unfreezeUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.UnfreezeUserResponse i) -> {
                  unfreezeUser_result res = new unfreezeUser_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(getUser_result bean) throws TException{
            ...
            public static class getUser<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, getUser_args, getUser_result>
            {
              public getUser()
              {
              ...
              public CompletableFuture<getUser_result> apply(UserServiceAsync iface, getUser_args getUser_args) throws SoaException
              {
                ...
                CompletableFuture<com.today36524.api.user.response.GetUserResponse> result = (CompletableFuture<com.today36524.api.user.response.GetUserResponse>) iface.getUser(getUser_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.GetUserResponse i) -> {
      ...
      public void validate(getUserByTelephone_result bean) throws TException{
            ...
            public static class getUserByTelephone<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, getUserByTelephone_args, getUserByTelephone_result>
            {
              ...
              @Override
              public CompletableFuture<getUserByTelephone_result> apply(UserServiceAsync iface, getUserByTelephone_args getUserByTelephone_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.GetUserResponse> result = (CompletableFuture<com.today36524.api.user.response.GetUserResponse>) iface.getUserByTelephone(getUserByTelephone_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.GetUserResponse i) -> {
                  getUserByTelephone_result res = new getUserByTelephone_result();
                  res.setSuccess(i);
                  return res;
              });
              }
      ...
      public void validate(findUsersByPage_result bean) throws TException{
            ...
            public static class findUsersByPage<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, findUsersByPage_args, findUsersByPage_result>
            {
              ...
              @Override
              public CompletableFuture<findUsersByPage_result> apply(UserServiceAsync iface, findUsersByPage_args findUsersByPage_args) throws SoaException
              {

                CompletableFuture<com.today36524.api.user.response.FindUsersByPageResponse> result = (CompletableFuture<com.today36524.api.user.response.FindUsersByPageResponse>) iface.findUsersByPage(findUsersByPage_args.request ,50000);

                return result.thenApply(( com.today36524.api.user.response.FindUsersByPageResponse i) -> {
                  findUsersByPage_result res = new findUsersByPage_result();
                  res.setSuccess(i);
                  return res;
              });
              }
        ...
        public static class getServiceMetadata<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaFunctionDefinition.Async<I, getServiceMetadata_args, getServiceMetadata_result> {
        ...
        public static class Processor<I extends com.today36524.api.user.service.UserServiceAsync> extends SoaServiceDefinition<com.today36524.api.user.service.UserServiceAsync>
        {

          public Processor(com.today36524.api.user.service.UserServiceAsync iface, Class<com.today36524.api.user.service.UserServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.today36524.api.user.service.UserServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
