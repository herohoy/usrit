 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class LoginUserResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.LoginUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.LoginUserResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.LoginUserResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,integral = integral,createdAt = createdAt,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.LoginUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.LoginUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.LoginUserResponse): String = if (bean == null) "null" else bean.toString
