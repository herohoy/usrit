 ...
 *  @generated
        ...
        **/
        ...
        @Processor(className = "com.today36524.api.user.scala.UserServiceCodec$Processor")
        trait UserService {
    ...
    ####  输出
        1.user_response.RegisterUserResponse
            ...
            **/
            ...
            def registerUser(
            request: com.today36524.api.user.scala.request.RegisterUserRequest ): com.today36524.api.user.scala.response.RegisterUserResponse
    ...
    ####  输出
        1.user_response.LoginUserResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def login(
            request: com.today36524.api.user.scala.request.LoginUserRequest ): com.today36524.api.user.scala.response.LoginUserResponse
    ...
    ####  输出
        1.user_response.ModifyUserAction
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def modifyUser(
            request: com.today36524.api.user.scala.request.ModifyUserRequest ): com.today36524.api.user.scala.response.ModifyUserResponse
    ...
    ####  输出
        1.user_response.FreezeUserResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def freezeUser(
            request: com.today36524.api.user.scala.request.FreezeUserRequest ): com.today36524.api.user.scala.response.FreezeUserResponse
    ...
    ####  输出
        1.user_response.BlackUserResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def blackUser(
            request: com.today36524.api.user.scala.request.BlackUserRequest ): com.today36524.api.user.scala.response.BlackUserResponse
    ...
    ####  输出
        1. i32 流水 Id
            ...
            **/
            ...
            request: com.today36524.api.user.scala.request.ChangeIntegralRequest ): Int
    ...
    ####  输出
        1.user_response.UnfreezeUserResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def unfreezeUser(
            request: com.today36524.api.user.scala.request.UnfreezeUserRequest ): com.today36524.api.user.scala.response.UnfreezeUserResponse
    ...
    ####  输出
        1.user_response.GetUserResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def getUser(
            request: com.today36524.api.user.scala.request.GetUserRequest ): com.today36524.api.user.scala.response.GetUserResponse
    ...
    ####  输出
        1.user_response.GetUserResponse
            ...
            **/
            ...
            request: com.today36524.api.user.scala.request.GetUserByTelephoneRequest ): com.today36524.api.user.scala.response.GetUserResponse
    ...
    ####  输出
        1.user_response.FindUsersByPageResponse
            ...
            **/
            ...
            @throws[com.github.dapeng.core.SoaException]
            def findUsersByPage(
            request: com.today36524.api.user.scala.request.FindUsersByPageRequest ): com.today36524.api.user.scala.response.FindUsersByPageResponse
