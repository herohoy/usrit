 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class BlackUserResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.BlackUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.BlackUserResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.BlackUserResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.BlackUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.BlackUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.BlackUserResponse): String = if (bean == null) "null" else bean.toString
