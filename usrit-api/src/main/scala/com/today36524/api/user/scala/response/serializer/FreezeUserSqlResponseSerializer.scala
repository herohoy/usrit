 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class FreezeUserSqlResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.FreezeUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.FreezeUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.FreezeUserSqlResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.FreezeUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("FreezeUserSqlResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.FreezeUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.FreezeUserSqlResponse): String = if (bean == null) "null" else bean.toString
