 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class FreezeUserResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.FreezeUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.FreezeUserResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.FreezeUserResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.FreezeUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.FreezeUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.FreezeUserResponse): String = if (bean == null) "null" else bean.toString
