 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class GetUserSqlResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.GetUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.GetUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.GetUserSqlResponse(userName = userName,telephone = telephone,email = email,qq = qq,status = status,integral = integral,createdAt = createdAt,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.GetUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("GetUserSqlResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.GetUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.GetUserSqlResponse): String = if (bean == null) "null" else bean.toString
