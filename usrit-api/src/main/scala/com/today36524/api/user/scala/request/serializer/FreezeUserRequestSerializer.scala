 package com.today36524.api.user.scala.request.serializer;
        ...
        **/
        ...
        class FreezeUserRequestSerializer extends BeanSerializer[com.today36524.api.user.scala.request.FreezeUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.request.FreezeUserRequest = {
      ...
      val bean = com.today36524.api.user.scala.request.FreezeUserRequest(userId = userId,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.request.FreezeUserRequest, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.request.FreezeUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.request.FreezeUserRequest): String = if (bean == null) "null" else bean.toString
