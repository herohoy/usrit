package com.today36524.api.user.scala
      ...
      override def validate(bean: registerUser_result): Unit = {
            ...
            class registerUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, registerUser_args, registerUser_result]("registerUser", new RegisterUser_argsSerializer(), new RegisterUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: registerUser_args):registerUser_result = {
      ...
      override def validate(bean: login_result): Unit = {
            ...
            class login extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, login_args, login_result]("login", new Login_argsSerializer(), new Login_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: login_args):login_result = {
      ...
      override def validate(bean: modifyUser_result): Unit = {
            ...
            class modifyUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, modifyUser_args, modifyUser_result]("modifyUser", new ModifyUser_argsSerializer(), new ModifyUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: modifyUser_args):modifyUser_result = {
      ...
      override def validate(bean: freezeUser_result): Unit = {
            ...
            class freezeUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, freezeUser_args, freezeUser_result]("freezeUser", new FreezeUser_argsSerializer(), new FreezeUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: freezeUser_args):freezeUser_result = {
      ...
      override def validate(bean: blackUser_result): Unit = {
            ...
            class blackUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, blackUser_args, blackUser_result]("blackUser", new BlackUser_argsSerializer(), new BlackUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: blackUser_args):blackUser_result = {
      ...
      override def validate(bean: changeUserIntegral_result): Unit = {
            ...
            class changeUserIntegral extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, changeUserIntegral_args, changeUserIntegral_result]("changeUserIntegral", new ChangeUserIntegral_argsSerializer(), new ChangeUserIntegral_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: changeUserIntegral_args):changeUserIntegral_result = {
      ...
      override def validate(bean: unfreezeUser_result): Unit = {
            ...
            class unfreezeUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, unfreezeUser_args, unfreezeUser_result]("unfreezeUser", new UnfreezeUser_argsSerializer(), new UnfreezeUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: unfreezeUser_args):unfreezeUser_result = {
      ...
      override def validate(bean: getUser_result): Unit = {
            ...
            class getUser extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, getUser_args, getUser_result]("getUser", new GetUser_argsSerializer(), new GetUser_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: getUser_args):getUser_result = {

              val _result = iface.getUser(args.request)
              getUser_result(_result )
            }
          }
      ...
      override def validate(bean: getUserByTelephone_result): Unit = {
            ...
            class getUserByTelephone extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, getUserByTelephone_args, getUserByTelephone_result]("getUserByTelephone", new GetUserByTelephone_argsSerializer(), new GetUserByTelephone_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: getUserByTelephone_args):getUserByTelephone_result = {

              val _result = iface.getUserByTelephone(args.request)
              getUserByTelephone_result(_result )
            }
          }
      ...
      override def validate(bean: findUsersByPage_result): Unit = {
            ...
            class findUsersByPage extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, findUsersByPage_args, findUsersByPage_result]("findUsersByPage", new FindUsersByPage_argsSerializer(), new FindUsersByPage_resultSerializer()){

            @throws[TException]
            def apply(iface: com.today36524.api.user.scala.service.UserService, args: findUsersByPage_args):findUsersByPage_result = {

              val _result = iface.findUsersByPage(args.request)
              findUsersByPage_result(_result )
            }
          }
  ...
  class getServiceMetadata extends SoaFunctionDefinition.Sync[com.today36524.api.user.scala.service.UserService, getServiceMetadata_args, getServiceMetadata_result](
  "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


      @throws[TException]
      override def apply(iface: com.today36524.api.user.scala.service.UserService, args: getServiceMetadata_args): getServiceMetadata_result = {
      ...
      class Processor(iface: com.today36524.api.user.scala.service.UserService, ifaceClass: Class[com.today36524.api.user.scala.service.UserService] ) extends
        SoaServiceDefinition(iface,classOf[com.today36524.api.user.scala.service.UserService], Processor.getProcessMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.today36524.api.user.scala.service.UserService, _, _]
