 package com.today36524.api.user.scala.request.serializer;
        ...
        **/
        ...
        class UnfreezeUserRequestSerializer extends BeanSerializer[com.today36524.api.user.scala.request.UnfreezeUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.request.UnfreezeUserRequest = {
      ...
      val bean = com.today36524.api.user.scala.request.UnfreezeUserRequest(userId = userId,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.request.UnfreezeUserRequest, oprot: TProtocol): Unit = {
      ...
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("UnfreezeUserRequest"))
            ...
            oprot.writeFieldBegin(new com.github.dapeng.org.apache.thrift.protocol.TField("remark", com.github.dapeng.org.apache.thrift.protocol.TType.STRING, 2.asInstanceOf[Short]))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.request.UnfreezeUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.request.UnfreezeUserRequest): String = if (bean == null) "null" else bean.toString
