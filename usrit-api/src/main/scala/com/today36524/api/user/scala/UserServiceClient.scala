package com.today36524.api.user.scala
        ...
        import com.today36524.api.user.scala.UserServiceCodec._;
        import com.today36524.api.user.scala.service.UserService;
 ...
 *  @generated
    ...
    ####  输出
        1.user_response.RegisterUserResponse
             ...
             **/
            def registerUser(request:com.today36524.api.user.scala.request.RegisterUserRequest ) : com.today36524.api.user.scala.response.RegisterUserResponse = {
    ...
    ####  输出
        1.user_response.LoginUserResponse
             ...
             **/
            def login(request:com.today36524.api.user.scala.request.LoginUserRequest ) : com.today36524.api.user.scala.response.LoginUserResponse = {
    ...
    ####  输出
        1.user_response.ModifyUserAction
             ...
             **/
            def modifyUser(request:com.today36524.api.user.scala.request.ModifyUserRequest ) : com.today36524.api.user.scala.response.ModifyUserResponse = {
    ...
    ####  输出
        1.user_response.FreezeUserResponse
             ...
             **/
            def freezeUser(request:com.today36524.api.user.scala.request.FreezeUserRequest ) : com.today36524.api.user.scala.response.FreezeUserResponse = {
    ...
    ####  输出
        1.user_response.BlackUserResponse
             ...
             **/
            def blackUser(request:com.today36524.api.user.scala.request.BlackUserRequest ) : com.today36524.api.user.scala.response.BlackUserResponse = {
    ...
    ####  输出
        1. i32 流水 Id
             ...
             **/
            def changeUserIntegral(request:com.today36524.api.user.scala.request.ChangeIntegralRequest ) : Int = {
    ...
    ####  输出
        1.user_response.UnfreezeUserResponse
             ...
             **/
            def unfreezeUser(request:com.today36524.api.user.scala.request.UnfreezeUserRequest ) : com.today36524.api.user.scala.response.UnfreezeUserResponse = {
    ...
    ####  输出
        1.user_response.GetUserResponse
             ...
             **/
            def getUser(request:com.today36524.api.user.scala.request.GetUserRequest ) : com.today36524.api.user.scala.response.GetUserResponse = {
    ...
    ####  输出
        1.user_response.GetUserResponse
             ...
             **/
            def getUserByTelephone(request:com.today36524.api.user.scala.request.GetUserByTelephoneRequest ) : com.today36524.api.user.scala.response.GetUserResponse = {
    ...
    ####  输出
        1.user_response.FindUsersByPageResponse
             ...
             **/
            def findUsersByPage(request:com.today36524.api.user.scala.request.FindUsersByPageRequest ) : com.today36524.api.user.scala.response.FindUsersByPageResponse = {
