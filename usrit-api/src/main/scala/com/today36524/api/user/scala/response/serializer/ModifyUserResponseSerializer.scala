 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class ModifyUserResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.ModifyUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.ModifyUserResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.ModifyUserResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.ModifyUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.ModifyUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.ModifyUserResponse): String = if (bean == null) "null" else bean.toString
