 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class ModifyUserSqlResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.ModifyUserSqlResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.ModifyUserSqlResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.ModifyUserSqlResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.ModifyUserSqlResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("ModifyUserSqlResponse"))
            ...
            oprot.writeFieldBegin(new com.github.dapeng.org.apache.thrift.protocol.TField("updatedAt", com.github.dapeng.org.apache.thrift.protocol.TType.I64, 6.asInstanceOf[Short]))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.ModifyUserSqlResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.ModifyUserSqlResponse): String = if (bean == null) "null" else bean.toString
