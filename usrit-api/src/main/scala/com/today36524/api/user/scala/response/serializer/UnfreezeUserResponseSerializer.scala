 package com.today36524.api.user.scala.response.serializer;
        ...
        **/
        ...
        class UnfreezeUserResponseSerializer extends BeanSerializer[com.today36524.api.user.scala.response.UnfreezeUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.response.UnfreezeUserResponse = {
      ...
      val bean = com.today36524.api.user.scala.response.UnfreezeUserResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.response.UnfreezeUserResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("UnfreezeUserResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.response.UnfreezeUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.response.UnfreezeUserResponse): String = if (bean == null) "null" else bean.toString
