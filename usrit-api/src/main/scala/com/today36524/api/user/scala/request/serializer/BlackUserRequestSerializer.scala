 package com.today36524.api.user.scala.request.serializer;
        ...
        **/
        ...
        class BlackUserRequestSerializer extends BeanSerializer[com.today36524.api.user.scala.request.BlackUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today36524.api.user.scala.request.BlackUserRequest = {
      ...
      val bean = com.today36524.api.user.scala.request.BlackUserRequest(userId = userId,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today36524.api.user.scala.request.BlackUserRequest, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today36524.api.user.scala.request.BlackUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today36524.api.user.scala.request.BlackUserRequest): String = if (bean == null) "null" else bean.toString
